...
for cam1, cam2 in camera_pairs:
    ...
    start_time = time.time()  # Start time for rectification
    ...
    rectification_time = time.time() - start_time  # End time for rectification

    start_time = time.time()  # Start time for depth map computation
    disparity_map, depth_map, depth_map_visual = compute_depth_map(left_rectified, right_rectified, Q)
    depth_map_time = time.time() - start_time  # End time for depth map computation

    print(f"Rectification Time for {cam1}-{cam2}: {rectification_time:.4f} seconds")
    print(f"Depth Map Computation Time for {cam1}-{cam2}: {depth_map_time:.4f} seconds")
